...
window.NIKENZUME_STRINGS = {
  ja: {
    ...
    chapter: ({ n }) => `第${n}章`,
    modeNormal: '通常', modeAdvanced: '上級', modeThree: '3面',
    // ボタン
    ...
    // 設定
    language: '言語', se: '効果音', haptics: '触覚フィードバック', levelLock: 'レベルロック',
  ...
  en: {
    ...
    chapter: ({ n }) => `Chapter ${n}`,
    modeNormal: 'Normal', modeAdvanced: 'Advanced', modeThree: 'Three',
    ...
    // settings
    language: 'Language', se: 'Sound', haptics: 'Haptics', levelLock: 'Level lock',

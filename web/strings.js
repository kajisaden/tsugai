...
window.NIKENZUME_STRINGS = {
  ja: {
    ...
    ht2title: '同時にゴールへ',
    ht2body: '各部屋にある光の輪がゴールです。2つの球が同じ一手で同時にゴールに入るとクリア。片方だけ先にゴールに入るのは反則です。',
    ht3title: '壁がズレを生む',
  ...
  en: {
    ...
    ht2body: 'The glowing ring in each room is the goal. Clear the puzzle by landing both balls on their goals in a single move. If only one ball enters its goal, that\'s a foul.',
